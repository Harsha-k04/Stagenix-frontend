  ...
  return (
    <div className="w-full h-full bg-black">
      ...
      <a-scene embedded renderer="antialias: true; colorManagement: true;">
        ...
        <a-entity light="type: directional; intensity: 0.8" position="1 4 3" />

        <a-camera position="0 1.6 8" far="10000" />
        ...
        {objects.map((o, i) => {
          ...
          return (
            <a-entity
              key={i}
              id={`model-${o.name}-${i}`}
              // ⭐ BYPASSING a-assets: Loading directly via URL to find the bottleneck
              gltf-model={url} 
              position={`${o.position[0]} 0 ${o.position[2] - 5}`}
        ...
        {/* This box confirms the center of your view */}
